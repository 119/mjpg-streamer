...
/home/k/1-git/4-mjpg-streamer/mjpg-streamer/2-lib/jpeg-6b/configure --prefix=/home/k/1-git/4-mjpg-streamer/mjpg-streamer/2-lib/build-RPi CC=arm-linux-gnueabihf-gcc --host=arm-linux-gnueabihf CFLAGS="-g " --exec-prefix=/home/k/1-git/4-mjpg-streamer/mjpg-streamer/2-lib/build-RPi/tmp 
make
sudo make install
